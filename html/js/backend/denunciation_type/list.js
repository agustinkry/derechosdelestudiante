$(document).ready(function () {
    var table = $('#example0').DataTable({
        ...
        "processing": true,
        "serverSide": true,
        "ajax": WEB_PATH + "controller/backend/ajax/denunciation_type/list.php"
    ...
    $("table.table").on("click", "i.action", function () {
        ...
        if ($(this).hasClass("delete")) {
            ...
            showConfirmation(GENERIC_ATENTION_MSG, GENERIC_DELETE_MSG, function () {
                ...
                $.ajax({
                    type: "POST",
                    url: WEB_PATH + "controller/backend/ajax/denunciation_type/delete.php",
                    data: {"id":id},
                    dataType: "json"
                }).done(function (data) {
                    $("#loading").fadeOut();
            ...
            window.location.href = ADMIN_URL + "denunciation_type/" + id;
        }
